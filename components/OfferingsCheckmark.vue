...
<template>
    <div>
        <svg fill="#FFFFFF" :height="height" :width="width" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 44.648 44.647"
	 xml:space="preserve">
        <g>
            <g>
